...
export const ICONS: Record<string, string> = {
  ...
  spellcheck: '<svg viewBox="0 0 16 16"><text x="1" y="9" font-size="8" font-family="sans-serif" font-weight="bold">abc</text><path d="M2 12.5q1.5-1.5 3 0t3 0t3 0t3 0" fill="none" stroke="#d0342c" stroke-width="1.2"/><path d="M9.5 6.5l2 2 3.5-4" fill="none" stroke="#2e7d32" stroke-width="1.6"/></svg>',
  ai: '<svg viewBox="0 0 16 16"><path d="M8 1.5l1.6 4.2 4.2 1.6-4.2 1.6L8 13.1 6.4 8.9 2.2 7.3l4.2-1.6z" fill="currentColor"/><path d="M13 10.5l.7 1.8 1.8.7-1.8.7-.7 1.8-.7-1.8-1.8-.7 1.8-.7z" fill="currentColor"/></svg>',
  ...
  showinsertions: '<svg viewBox="0 0 16 16"><path d="M3 3h10M3 13h10" stroke="currentColor" fill="none"/><path d="M8 5v6M6 7l2-2 2 2" stroke="#2a8a2a" fill="none"/></svg>',
  showdeletions: '<svg viewBox="0 0 16 16"><path d="M3 3h10M3 13h10" stroke="currentColor" fill="none"/><path d="M6 8h4" stroke="#b02020"/><path d="M6 6l4 4M10 6l-4 4" stroke="#b02020" opacity="0.6"/></svg>',
