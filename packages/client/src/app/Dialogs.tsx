...
export const HELP_ROWS: [string, string][] = [
    ...
    ['Ctrl+0 … Ctrl+6', 'Heading level: Part, Chapter, Section, Subsection, Subsubsection, Paragraph, Subparagraph (LyX\u2019s Alt+P digits)'],
    ['Ctrl+Alt+0 … Ctrl+Alt+6', 'The unnumbered heading (Part*, Chapter*, Section*, …)'],
    ...
    ['- ␣, 1. ␣, # ␣ at a paragraph start', 'Bullet list, numbered list, heading (markdown-style, like Google Docs; Backspace puts the marker back)'],
    ...
    ['Ctrl+Alt+D, Ctrl+\\', 'Reset font (clear formatting)'],
    ['Ctrl+K', 'Link: over the selected text, or change the link at the cursor — also inside formulas (an address pasted over selected text links it too)'],
    ['Ctrl+J', 'Rewrite with AI (when switched on: Tools ▸ AI assistance)'],
    ...
    ['Ctrl++ / Ctrl+-', 'Zoom the text (the interface keeps its size); reset: View ▸ Reset zoom'],
